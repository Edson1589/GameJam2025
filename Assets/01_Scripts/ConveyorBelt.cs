...
public class ConveyorBelt : MonoBehaviour
{
    ...
    // Usar triggers para detecci�n m�s confiable
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (rb != null && !objectsOnBelt.Contains(rb))
        {
            ...
            Debug.Log($"Objeto '{other.gameObject.name}' entr� en cinta");
        }
    }

    private void OnTriggerStay(Collider other)
    {
        // Mantener objetos en la lista mientras est�n encima
        Rigidbody rb = other.GetComponent<Rigidbody>();
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (rb != null && objectsOnBelt.Contains(rb))
        {
            ...
            Debug.Log($"Objeto '{other.gameObject.name}' sali� de cinta");
        }
    }
    ...
    {
        direction = -direction;
        Debug.Log($"Cinta '{gameObject.name}' cambi� direcci�n a {direction}");
    }

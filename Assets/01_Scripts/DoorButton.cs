...
public class DoorButton : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            {
                // Pressure plate se activa autom�ticamente
                if (!isActive)
                {
                    Activate();
                }
    ...
    private void Activate()
    {
        ...
        Debug.Log($"Bot�n '{gameObject.name}' ACTIVADO - Puerta abierta por 5s");

        // Auto-desactivar despu�s de que la puerta se cierre
    ...
    private void Deactivate()
    {
        ...
        Debug.Log($"Bot�n '{gameObject.name}' DESACTIVADO");
    }

    private void AnimatePress()
    {
        // Animar el bot�n hundi�ndose
        transform.position = pressedPosition;
    }

    private void AnimateRelease()
    {
        // Animar el bot�n subiendo
